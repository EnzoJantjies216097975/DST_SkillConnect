package com.dst511s.dst_skillconnect.screens.home
...
import com.dst511s.dst_skillconnect.components.ActivityItem
import com.dst511s.dst_skillconnect.components.HomeJobCard
import com.dst511s.dst_skillconnect.components.HomeSection
import com.dst511s.dst_skillconnect.components.HomeWorkshopCard
import com.dst511s.dst_skillconnect.components.SkillDevelopmentSection
import com.dst511s.dst_skillconnect.components.WelcomeSection
import com.dst511s.dst_skillconnect.data.models.ActivityType
import com.dst511s.dst_skillconnect.data.models.Workshop
...
fun JobMatchesRow() {
    val jobs = remember {
        listOf(
            com.dst511s.dst_skillconnect.data.models.Job(
                id = "1",
...
fun RecentActivitiesSection() {
    val activities = remember {
        listOf(
            com.dst511s.dst_skillconnect.data.models.Activity(
